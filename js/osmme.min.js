...
for(var g=b.name2FClass[a.poi_class[0]],h={opening_hours:{"24_7":!1}},l=0;l<e.length;l++){var q=e[l],t=[],u=Object.keys(a.tags[q])||[];if(u&&0<u.length){for(var w=0;w<u.length;w++){var x=u[w],y=g.more_tags[q].values;y&&y[x]&&t.push({valueKey:x,valueTitle:y[x].name})}if(0<t.length)for(d[q]={key:q,type:g.more_tags[q].valueType,title:g.more_tags[q].name,options:t},d._ordered_keys.push(q),h[q]={},u=0;u<t.length;u++)h[q][t[u].valueKey]=!1;else g.more_tags[q]&&"BOOLEAN"==g.more_tags[q].valueType&&(h[q]=
!1,d[q]={key:q,type:g.more_tags[q].valueType,title:g.more_tags[q].name},d._ordered_keys.push(q))}}b.poi_subfilters=d;b.activePoiFilters=h}):b.poi_subfilters=null}};return g}])})(angular,meOSMDoc);var meDetails=angular.module("meDetails",["meMap","meI18n"]);
