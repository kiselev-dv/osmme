...
2;n.panTo(n.unproject(d),{animate:!1});d=a.popup._source?a.popup._source.feature_id:a.popup.feature_id;f(a.popup._contentNode)(l);l.$broadcast("PopupOpen",d,m.id2Feature[d].poi_class);b.$$phase||b.$apply()});this.map.on("popupclose",function(a){l.$broadcast("PopupClose",a.popup._source?a.popup._source.feature_id:a.popup.feature_id);b.$$phase||b.$apply()});this.ready=!0;if(!l.mobile){var x=this.searchControl=(new e).setScope(l);k.get(HTML_ROOT+"/templates/search_control.html").success(function(a){x.setContainer(a);
x.addTo(n);f(x.container)(l)})}return this.map},createPopUP:function(a,b){if(!this.id2Feature[b.feature_id]){this.id2Feature[b.feature_id]=b;var f=b.poi_class?a.name2FClass[b.poi_class[0]]:null,d=this;this.loadIcon(f,function(){var g=L.marker([b.center_point.lat,b.center_point.lon]);f&&f.ll_icon&&(g=L.marker([b.center_point.lat,b.center_point.lon],{icon:f.ll_icon}));d.id2Marker[b.feature_id]=g;var k=d.getPopUPHtml(b,b.feature_id,a,f);g.addTo(d.map).bindPopup(k);g.feature_id=b.feature_id})}},openPopUP:function(a,
