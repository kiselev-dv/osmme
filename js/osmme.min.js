...
function(d,e){d.selected?g.addSelection.apply(g,[a,d,e]):g.removeSelection.apply(g,[a,d,e]);var h=g.expandCathegories.apply(g,[a]);b.filterMarkersByTypes.apply(b,[a,h])};a.listMoreTags=function(b){if(!b||!a.name2FClass)return null;if(b.__translatedTags&&0<b.__translatedTags.length)return b.__translatedTags;var d=b.poi_class,e=[];angular.forEach(b.more_tags,function(b,g){if("description"!=g)for(var l in d){var h={},n=a.name2FClass[d[l]];n&&(n=n.more_tags[g])&&(h.name=n.name,h.type=n.valueType,h.key=
